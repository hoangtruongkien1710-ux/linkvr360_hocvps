...
type Branch = { id?: string; name: string; phuongXaId: string; diaChi: string | null; soDienThoai: string | null };
type Tour = {
  id: string;
  brand: string;
  type: string;
...
const emptyBranch = (): Branch => ({ name: '', phuongXaId: '', diaChi: '', soDienThoai: '' });
...
export default function HomePage() {
  ...
  function openEdit(tour: Tour) {
    ...
    setForm({
      ...
      url: tour.url,
      status: tour.status,
      chiNhanhs: tour.chiNhanhs.map(({ id, name, phuongXaId, diaChi, soDienThoai }) => ({ id, name, phuongXaId, diaChi, soDienThoai })),
    });
    setShowForm(true);
  }
